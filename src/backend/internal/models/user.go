...
type RegisterRequest struct {
	...
	VerifyCode string `json:"verify_code" binding:"required" example:"A9d3"`                      // 图形验证码内容，不区分大小写
	CaptchaKey string `json:"captcha_key" binding:"required" example:"01J0XYZABCD1234EFG567HIJK"` // 验证码编码
...
type RegisterResponse struct {
	UserID string `json:"user_id" example:"01HZX1YF8Y6S7K4V9Q2J3M5N6P"`            // 用户ID
